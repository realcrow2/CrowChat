...
Citizen.CreateThread(function()
	...
	if Config.EnableStaffCommand then
		TriggerEvent('chat:addSuggestion', '/'..Config.StaffCommand, 'Send a staff announcement',{})
	end
	
	if Config.EnableStaffOnlyCommand then
		TriggerEvent('chat:addSuggestion', '/'..Config.StaffOnlyCommand, 'Send a staff team message',{})
	end
	
	TriggerEvent('chat:addSuggestion', '/gme', 'Global Me - Describe an action globally',{})
	TriggerEvent('chat:addSuggestion', '/do', 'Do - Describe an action you are performing',{})
	TriggerEvent('chat:addSuggestion', '/social', 'Post to social media (FiveM TOS Friendly)',{})
	TriggerEvent('chat:addSuggestion', '/sms', 'Send a private message to a player',{
		{ name = "player_id", help = "The server ID of the player" },
		{ name = "message", help = "Your message" }
	})
	TriggerEvent('chat:addSuggestion', '/lockchat', 'Lock the chat so only staff can send messages',{})
	TriggerEvent('chat:addSuggestion', '/unlockchat', 'Unlock the chat so everyone can send messages',{})
end)